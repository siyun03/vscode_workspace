...
// str2 = 'a ab aa abc aaa ac abcd';

console.log(str2.match(/[0-9]/g)); // null, 숫자 하나, = \d

console.log(str2.match(/[a-zA-Z]/g)); // 영문자 하나
/*
[
  'a', 'a', 'b', 'a', 'a',
  'a', 'b', 'c', 'a', 'a',
...
console.log(str2.match(/[a-zA-Z_]/g)); // 워드(영대소문자 또는 _) 하나 = \w
/*
[
  'a', 'a', 'b', 'a', 'a',
  'a', 'b', 'c', 'a', 'a',
